...
import { WEIGHT_TOLERANCE, insertNotificationRuleSchema, insertAddOnSchema } from "@shared/schema";
...
export function registerAdminRoutes(app: Express) {
  ...
  // ════════════════════════════════════════════════════════════════
  //  PARTNER APPLICATIONS — Driver / Laundromat sign-up + admin approval
  // ════════════════════════════════════════════════════════════════
