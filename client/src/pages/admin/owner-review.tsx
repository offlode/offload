            ...
            <CardContent>
              <Table>
                ...
                <TableBody>
                  ...
                  <TableRow><TableCell>Embedded interactive map (customer)</TableCell><TableCell><Badge className="bg-green-600 text-white">Yes (sandbox + prod)</Badge></TableCell><TableCell><Badge className="bg-green-600 text-white">Yes</Badge></TableCell><TableCell><Badge className="bg-green-600 text-white">Yes</Badge></TableCell><TableCell><strong>OD-7 closed:</strong> EmbeddedTrackingMap component, WS-driven, falls back cleanly when key/coords missing</TableCell></TableRow>
          ...
          <Card>
            ...
            <CardContent>
              <Table>
                ...
                <TableBody>
                  <TableRow><TableCell>OD-1</TableCell><TableCell>Hide alterations + commercial from customer self-serve?</TableCell><TableCell>Hidden + FAQ softened</TableCell><TableCell><Badge className="bg-green-600 text-white">Closed</Badge></TableCell></TableRow>
                  <TableRow><TableCell>OD-2</TableCell><TableCell>Add Google Maps key to sandbox for pricing parity?</TableCell><TableCell>Maps key set on sandbox-api</TableCell><TableCell><Badge className="bg-green-600 text-white">Closed</Badge></TableCell></TableRow>
                  <TableRow><TableCell>OD-3</TableCell><TableCell>Refresh Owner Review website tab with live numbers?</TableCell><TableCell>Live quote probe above</TableCell><TableCell><Badge className="bg-green-600 text-white">Closed</Badge></TableCell></TableRow>
                  <TableRow><TableCell>OD-4</TableCell><TableCell>Drop “Chat with driver” from marketing?</TableCell><TableCell>Relabeled to “Message support about this order”; site copy softened</TableCell><TableCell><Badge className="bg-green-600 text-white">Closed</Badge></TableCell></TableRow>
                  <TableRow><TableCell>OD-5</TableCell><TableCell>Drop “Stripe Connect / weekly direct deposits”?</TableCell><TableCell>Site copy: “payouts recorded weekly; direct deposit rolling out”</TableCell><TableCell><Badge className="bg-green-600 text-white">Closed</Badge></TableCell></TableRow>
                  <TableRow><TableCell>OD-6</TableCell><TableCell>Drop “24/7 / Platinum support”?</TableCell><TableCell>Replaced with “In-app order support / priority support response”</TableCell><TableCell><Badge className="bg-green-600 text-white">Closed</Badge></TableCell></TableRow>
                  <TableRow><TableCell>OD-7</TableCell><TableCell>Add embedded map widget to customer tracking?</TableCell><TableCell>EmbeddedTrackingMap component with WS-driven driver marker + clean fallback</TableCell><TableCell><Badge className="bg-green-600 text-white">Closed</Badge></TableCell></TableRow>
                  <TableRow><TableCell>OD-8</TableCell><TableCell>Move wait-fee constants to DB?</TableCell><TableCell>pricing_config keys: wait_fee_free_minutes / per_minute / cap (admin UI editable)</TableCell><TableCell><Badge className="bg-green-600 text-white">Closed</Badge></TableCell></TableRow>
                  <TableRow><TableCell>OD-9</TableCell><TableCell>Per-jurisdiction tax table?</TableCell><TableCell>NYC flat 8.875% (deferred)</TableCell><TableCell><Badge variant="secondary">Deferred</Badge></TableCell></TableRow>
                  <TableRow><TableCell>OD-10</TableCell><TableCell>Deploy wave5b-part30 admin assignment fix to PRODUCTION?</TableCell><TableCell>Prod-api running 21daf06f (part 30 + 31); order 49 assignment verified</TableCell><TableCell><Badge className="bg-green-600 text-white">Closed</Badge></TableCell></TableRow>
                </TableBody>
              </Table>
            </CardContent>
          </Card>
